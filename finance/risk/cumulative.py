...
class RiskMetricsCumulative(object):
    ...
    def __init__(self, sim_params,
        ...
        self.trading_days = env.days_in_range(
            self.start_date,
            self.end_date)
    ...
    def get_minute_index(self, sim_params):
        ...
        for day in self.trading_days:
            minutes_for_day = self.env.market_minutes_for_day(day)
    ...
    def update(self, dt, algorithm_returns, benchmark_returns):
        ...
        print "daily returns: ", algorithm_returns
        #print "algo cumulative returns: ", self.algorithm_cumulative_returns[dt]
